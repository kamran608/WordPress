			...
			<div id="edd-header-wrapper">
				...
				<div id="edd-header-actions">
					<button
						...
						onclick="if(window.eddNotifications){window.eddNotifications.openPanel();}"
					>
						<span
							class="edd-round edd-number<?php echo 0 === $number_notifications ? ' edd-hidden' : ''; ?>"
						>
							<span id="edd-notification-count"><?php echo esc_html( $number_notifications ); ?></span>
							<span class="screen-reader-text"><?php esc_html_e( 'unread notifications', 'easy-digital-downloads' ); ?></span>
						</span>
