 ...
 * Admin
 *
 * @package     GamiPress\Asgaros_Forum\Admin
 * @since       1.0.0
 */
 ...
 * @return mixed
 */
function gamipress_asgaros_forum_get_option( $option_name, $default = false ) {
 ...
 * @return mixed
 */
function gamipress_asgaros_forum_settings_meta_boxes( $meta_boxes ) {

    $prefix = 'wpforo_';

    $meta_boxes['gamipress-asgaros-forum-settings'] = array(
        'title' => __( 'wpForo', 'gamipress' ),
        'fields' => apply_filters( 'gamipress_asgaros_forum_settings_fields', array(
            ...
            $prefix . 'points_types' => array(
                ...
                'type' => 'multicheck',
                'options_cb' => 'gamipress_asgaros_forum_points_types_option_cb',
            ),
            ...
            $prefix . 'achievement_types' => array(
                ...
                'type' => 'multicheck',
                'options_cb' => 'gamipress_asgaros_forum_achievement_types_option_cb',
            ),
            ...
            $prefix . 'rank_types' => array(
                ...
                'type' => 'multicheck',
                'options_cb' => 'gamipress_asgaros_forum_rank_types_option_cb',
            ),
        ...
        'vertical_tabs' => true,
        'tabs' => apply_filters( 'gamipress_asgaros_forum_settings_tabs', array(
            'points' => array(
...
add_filter( 'gamipress_settings_addons_meta_boxes', 'gamipress_asgaros_forum_settings_meta_boxes' );

function gamipress_asgaros_forum_points_types_option_cb() {
...
function gamipress_asgaros_forum_achievement_types_option_cb() {
...
function gamipress_asgaros_forum_rank_types_option_cb() {
...
function gamipress_asgaros_forum_save_gamipress_settings() {
...
add_action( 'cmb2_save_options-page_fields', 'gamipress_asgaros_forum_save_gamipress_settings' );
 ...
 * @return array
 */
function gamipress_asgaros_forum_automatic_updates( $automatic_updates_plugins ) {
...
add_filter( 'gamipress_automatic_updates_plugins', 'gamipress_asgaros_forum_automatic_updates' );